...
with open("../expected_outputs/aci_composition_sweep_repro.csv","w",newline="") as f:
    wtr=_csv.DictWriter(f,fieldnames=list(rows_out[0].keys())); wtr.writeheader(); wtr.writerows(rows_out)
print("\nSaved expected_outputs/aci_composition_sweep_repro.csv")
...
_plt.tight_layout(); _plt.savefig("../expected_outputs/aci_composition_sweep_repro.png",dpi=140); _plt.close()
print("Saved expected_outputs/aci_composition_sweep_repro.png")
